...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let listRecord = {id = new_id(); action = listener} in
    evt := listRecord::(!evt);
    listRecord.id
...
......................................................................*)
  ...
  let rec remove_listener (evt : 'a event) (i : id) : unit =
    match !evt with
    |[] -> ()
    |x -> evt := (List.filter (fun y-> y.id <> i) x)
(*......................................................................
...
......................................................................*)
  ...
  let rec fire_event (evt : 'a event) (arg : 'a) : unit =
    match !evt with
    |[] -> ()
    |hd::tl -> hd.action arg; fire_event (ref tl) arg
...
(* .. *)
let fakeListener = WEvent.add_listener (newswire) (fakeNewsNetwork);;
let buzzListener = WEvent.add_listener (newswire) (buzzFake);;
...
(* .. *)
WEvent.remove_listener (newswire) (fakeListener);;
WEvent.remove_listener (newswire) (buzzListener);;
